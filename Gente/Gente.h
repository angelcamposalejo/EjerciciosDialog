...
protected:
	...
	{
		this->Text = L"Gente";
		btColor.Create(NULL, L"Color", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 376, 39, 86, 28, hWnd, 1000);
		xy1.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_VISIBLE, 19, 33, 294, 210, hWnd, 1001);
		fontArial014A.Create(L"Arial", 14, false, false, false, false);
		btColor.Font = fontArial014A;
		xy1.Font = fontArial014A;
	}
	//_________________________________________________
	void btColor_Click(Win::Event& e);
	void Window_Open(Win::Event& e);
	//_________________________________________________
	bool EventHandler(Win::Event& e)
	{
		if (btColor.IsEvent(e, BN_CLICKED)) { btColor_Click(e); return true; }
		return false;
	}
};
